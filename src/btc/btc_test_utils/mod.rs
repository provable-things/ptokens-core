...
pub const SAMPLE_BTC_BLOCK_JSON_PATH: &str =
    "src/btc/btc_test_utils/604700-btc-block-and-txs.json";
...
pub const SAMPLE_TESTNET_BTC_BLOCK_JSON_PATH: &str =
    "src/btc/btc_test_utils/1610046-testnet-block-with-tx-to-test-address.json";

pub const SAMPLE_TESTNET_BTC_BLOCK_JSON_PATH_2: &str =
    "src/btc/btc_test_utils/1610166-testnet-block-with-tx-to-test-address.json";

pub const SAMPLE_TESTNET_BTC_BLOCK_JSON_PATH_3: &str =
    "src/btc/btc_test_utils/1610161-testnet-block-with-tx-to-test-address.json";

pub const SAMPLE_TESTNET_BTC_BLOCK_JSON_PATH_5: &str =
    "src/btc/btc_test_utils/1637173-testnet-block-and-txs-with-p2sh-deposit.json";

pub const SAMPLE_TESTNET_BTC_BLOCK_JSON_PATH_6: &str =
    "src/btc/btc_test_utils/1660807-testnet-block-and-txs-with-2-p2sh-deposits.json";

pub const SAMPLE_TESTNET_BTC_BLOCK_JSON_PATH_7: &str =
    "src/btc/btc_test_utils/btc-1661479-btc-block-and-txs-with-deposit-originating-from-enclave-key.json";

pub const SAMPLE_TESTNET_BTC_BLOCK_JSON_PATH_8: &str =
    "src/btc/btc_test_utils/1661611-block-and-txs-with-no-op-return.json";

pub const SAMPLE_TESTNET_BTC_BLOCK_JSON_PATH_9: &str =
    "src/btc/btc_test_utils/1666951-block-and-txs-p2sh-and-op-return-below-threshold.json";

pub const SAMPLE_TESTNET_OP_RETURN_BTC_BLOCK_JSON: &str =
    "src/btc/btc_test_utils/1610826-testnet-block-with-tx-to-test-address.json";
...
pub fn get_sample_sequential_btc_blocks_in_db_format(
    ...
    let path_prefix = "src/btc/btc_test_utils/sequential_block_and_ids/";

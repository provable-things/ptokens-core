use crate::{
    chains::eth::{
        eth_constants::{BTC_ON_ETH_REDEEM_EVENT_TOPIC, ERC20_ON_EOS_PEG_IN_EVENT_TOPIC},
        eth_database_utils::{get_erc20_on_eos_smart_contract_address_from_db, get_erc777_contract_address_from_db},
        eth_state::EthState,
    },
...
pub fn filter_receipts_for_btc_on_eth_redeem_events_in_state<D>(state: EthState<D>) -> Result<EthState<D>>
where
    D: DatabaseInterface,
{
...
pub fn filter_receipts_for_erc20_on_eos_peg_in_events_in_state<D>(state: EthState<D>) -> Result<EthState<D>>
where
    D: DatabaseInterface,
{
